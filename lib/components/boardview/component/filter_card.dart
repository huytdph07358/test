...
class _FilterCardState extends State<FilterCard> {
  ...
  resetFilters() {
    this.setState(() {
      widget.filters["noMember"] = false;
      widget.filters["members"] = [];
      widget.filters["labels"] = [];
      widget.filters["priority"] = null;
      widget.filters["dueDate"] = {};
    });
    widget.resetFilters();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final members = filters["members"];
    final noMember = filters["noMember"];
    final priority = filters["priority"];
    final labels = filters["labels"];
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("Filter", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400)),
                InkWell(
                  onTap: () {
                  ...
                  child: Padding(
                    ...
                    child: Text("Done", style: TextStyle(color: isDark ? Color(0xffFAAD14) : Colors.blueAccent)),
                  )
                )
              ]
            )
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          height: 38,
                          child: Text("${S.current.members}:", style: TextStyle(color: isDark ? null : Color(0xff5E5E5E)))
                        ),
                        InkWell(
                          onTap: () {
                            setState(() {
                  ...
                  // Divider(color: isDark ? Color(0xff5E5E5E) : Color(0xffDBDBDB), height: 1, thickness: 1),
                  // SelectfilterType(filterType: widget.filterType, onChangeFilterType: widget.onChangeFilterType),
                  SizedBox(height: 10),
                ],
              ),
            ),
    ...
    return InkWell(
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(S.current.anyMatch),
                            Text(S.current.matchAnyLabelAnd, style: TextStyle(fontSize: 11, color: isDark ? Color(0xffDBDBDB) : Color(0xff5E5E5E)))
                          ]
                        )
                      )
                    ),
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(widget.filterType == "exact" ? S.current.exactMatch : S.current.anyMatch, style: TextStyle(color: isDark ? Color(0xffDBDBDB) : Color(0xff5E5E5E))),
    ...
    return Column(
      children: [
        Container(
          ...
          alignment: Alignment.centerLeft,
          height: 38,
          child: Text("${S.current.dueDate}:", style: TextStyle(color: isDark ? null : Color(0xff5E5E5E)))
        ),
        InkWell(
          onTap: () {
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text(S.current.noDueDate, style: TextStyle(color: isDark ? null : Color(0xff5E5E5E)))
                  ]
                ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text(S.current.overdue, style: TextStyle(color: isDark ? null : Color(0xff5E5E5E)))
                  ]
                ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    ) : Text(S.current.after, style: TextStyle(color: isDark ? null : Color(0xff5E5E5E)))
                  ]
                )
              ),
                ...
                child: Row(
                  children: [
                    ...
                    widget.filters["dueDate"]["before"] != null ? Row(
                      children: [
                        Text("${S.current.before} "),
                        Text(
                          "${DateFormatter().renderTime(DateTime.parse("${widget.filters['dueDate']['before']}"), type: 'yMMMd')}",
                          style: TextStyle(color: isDark ? Color(0xffDBDBDB) : Color(0xff5E5E5E), fontSize: 14)
                        )
                      ]
                    ) : Text(S.current.before, style: TextStyle(color: isDark ? null : Color(0xff5E5E5E)))
                  ]
                )
              ),
...
class _FilterMemberState extends State<FilterMember> {
  ...
  Widget build(BuildContext context) {
    ...
    final channelMember = Provider.of<Channels>(context, listen: true).channelMember.where((e) => e["id"] != userId).toList();
        ...
        child: widget.members.length > 0 ? Row(
          ...
          children: [
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("${S.current.selected}: ", style: TextStyle(color: Color(0xffA6A6A6))),
                Wrap(
          ...
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(S.current.chooseAMember, style: TextStyle(color: isDark ? Color(0xffDBDBDB) : Color(0xff5E5E5E))),
            Icon(PhosphorIcons.caretDown, color: isDark ? Color(0xffDBDBDB) : Color(0xff5E5E5E), size: 20)
          ]
        )
      )
...
class _FilterPriorityState extends State<FilterPriority> {
  ...
  Widget build(BuildContext context) {
    final bool isDark = Provider.of<Auth>(context, listen: false).theme == ThemeType.DARK;
    print("widgett priority ${widget.priority}");
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("${S.current.priority}:", style: TextStyle(color: isDark ? null : Color(0xff5E5E5E))),
          SizedBox(height: 8),
          Wrap(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("${S.current.labels}:", style: TextStyle(color: isDark ? Palette.defaultTextDark : Color(0xff5E5E5E))),
          SizedBox(height: 8),
          // Divider(color: isDark ? Color(0xff5E5E5E) : Color(0xffDBDBDB), height: 1, thickness: 1),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return Container(
      ...
      child: InkWell(
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: CupertinoTextField(
                            ...
                            style: TextStyle(fontSize: 14, color: Color(0xffA6A6A6)),
                            placeholder: S.current.searchLabel,
                            placeholderStyle: TextStyle(fontSize: 14, color: Color(0xffA6A6A6))
                          )
                        )
                      ),
        ...
        child: selectedLabels.length > 0 ? Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text("${selectedLabels.length} ${S.current.labelSelected}", style: TextStyle(color: Color(0xffFAAD14))),
            Icon(PhosphorIcons.caretDown, color: Color(0xffFAAD14), size: 20)
          ]
        ) : Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(S.current.chooseALabel, style: TextStyle(color: isDark ? Color(0xffDBDBDB) : Color(0xff5E5E5E))),
            Icon(PhosphorIcons.caretDown, color: isDark ? Color(0xffDBDBDB) : Color(0xff5E5E5E), size: 20)
          ]
        )
      )
