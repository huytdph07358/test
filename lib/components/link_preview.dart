...
class WebAnalyzer {
  ...
  static Future<Response?> _requestUrl(String url,
    ...
    final stream = await client.send(request).timeout(Duration(seconds: 5));
...
class _LinkPreviewState extends State<LinkPreview> {
  ...
  //     info = await WebAnalyzer.getInfo(
  //       widget.url.trim(),
  //     );
  //     if (mounted) setState(() {});
  //   } else {
  ...
  Widget build(BuildContext context) {
    ...
    return (info == null || (image == null && title == null && description == null)) ? Container() : Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              children: <Widget>[
                if (Utils.checkedTypeEmpty(icon)) Container(
          ...
          SizedBox(height: 10),
          CachedImage(
            image ?? "https://statics.pancake.vn/panchat-prod/2021/9/14/904ef09383d868b77e6304953370e52b256f1937.png",
            width: 100,
            height: 100,
            fit: BoxFit.cover
          )
