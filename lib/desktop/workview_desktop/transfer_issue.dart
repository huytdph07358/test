...
class _TransferIssueState extends State<TransferIssue> {
  ...
  onTransferIssue(selectedItem) async {
    ...
    try {
      ...
      if (resData["success"]) {
        ...
        Provider.of<Channels>(context, listen: false).getListIssue(token, currentWorkspace["id"], currentChannel["id"], 1, false, [], "newest", "");
  ...
  Widget build(BuildContext context) {
    ...
    final channels = data.where((e) => e["workspace_id"] == currentWorkspace["id"] && (widget.issue != null && e["id"] != widget.issue["channel_id"])).toList();
